...
while True:
    ...
    cv2.putText(frame, "Percentage of Neutral Reaction  : " + str(netpercent) + " %", (50, 530),
                cv2.FONT_HERSHEY_DUPLEX, 0.9, (0, 255, 0), 2)
    cv2.putText(frame, "Percentage of Positive Reaction : " + str(pospercent) + " %", (50, 560),
                cv2.FONT_HERSHEY_DUPLEX, 0.9, (0, 255, 0), 2)
    cv2.putText(frame, "Percentage of Negative Reaction : " + str(negpercent) + " %", (50, 590),
                cv2.FONT_HERSHEY_DUPLEX, 0.9, (0, 255, 0), 2)

    cv2.putText(frame, "Number of Neutral Reactions  : " + str(netinterest), (50, 620),
                cv2.FONT_HERSHEY_DUPLEX, 0.9, (0, 255, 0), 2)
    cv2.putText(frame, "Number of Positive Reactions : " + str(posinterest), (50, 650),
                cv2.FONT_HERSHEY_DUPLEX, 0.9, (0, 255, 0), 2)
    cv2.putText(frame, "Number of Negative Reactions : " + str(neginterest), (50, 680),
                cv2.FONT_HERSHEY_DUPLEX, 0.9, (0, 255, 0), 2)
